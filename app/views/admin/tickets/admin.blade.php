...
@section('content')
    ...
    {{ Form::open(array('url' => 'dashboard/admin', 'method' => 'post',
        ...
        jQuery("#admin").jqGrid({
                    ...
                    "colModel":[
                       // {"label":"Action",'name':'act','index':'act', 'width':75,'sortable':false},
                        ...
                        {'label':'Ticket ID', 'name':'ticket_id', 'index':'ticket_id', 'width':65, 'align':'center',"formatter":"integer",sorttype:'number'},
                        {"label":"Request Id",'width':75,"align":"center","index":"seller_request_id","name":"seller_request_id", 'hidden' : true},

                        {"label":"Local Team Lead", "name":"localteamlead_id", "index":"localteamlead_id","align":"center","width":130,
                            "editable":true, "editoptions":{'value':'{{rtrim($localTeamLead, ";")}}'},"edittype":"select","formatter":"select", "id":"localteamlead_id"},

                        {"label":"Editing Manager", "name":"editingmanager_id", "index":"editingmanager_id","align":"center","width":130,
                            "editable":true, "editoptions":{'value':'{{rtrim($editingManager, ";")}}'},"edittype":"select","formatter":"select", "id":"editingmanager_id"},
                        ...
                        {"label":"Cataloging Manager", "name":"catalogingmanager_id", "index":"catalogingmanager_id","align":"center","width":130,
                            "editable":true, "editoptions":{'value':'{{rtrim($catalogueManager, ";")}}'},"edittype":"select","formatter":"select", "id":"catalogingmanager_id"},
...
//                        {"label":"Request / Assigned Date","align":"center","index":"created_at","name":"created_at","width":160},
                        {"label":"Priority","index":"priority","align":"center","width":75,"editable":true,
                        "editoptions":{'value':'{{rtrim($priority, ";")}}'},"edittype":"select","formatter":"select","editrules":{"required":true},"name":"priority"},

                        {"label":"Group","index":"group_id","align":"center","width":100,"editable":true,
