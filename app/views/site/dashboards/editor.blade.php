    ...
    <script type="text/javascript">
        ...
        jQuery("#editor").jqGrid({
                    ...
                    "colModel":[
                        ...
                        {"label":"Status","index":"status_id","align":"center","width":110,
                        "editable":true, "editoptions":{'value':'{{rtrim($status, ";")}}',"disabled": 'disabled'},"edittype":"select", "formatter":"select","editrules":{"required":true},"name":"status_id", 'hidden' : true},
                    ...
                    "subGridModel" :[
                        {
                            ...
                            width : [200,200,120,200,200,200,200,200,200,200,200,200,200,200,200]
                        }
                    ],
                    "pager":"editorPager"
                }
