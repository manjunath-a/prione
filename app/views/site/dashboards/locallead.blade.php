        ...
        jQuery("#locallead").jqGrid({
                   ...
                   // "autowidth":true,
                    ...
                    "colModel":[
                        ...
                        'align':'center', 'key':true, 'hidden' : false},
                        ...
                        {"label":"Stage","index":"stage_id","align":"center","width":320,"editable":true,
                       ...
                       // {"label":"Status","index":"status_id","align":"center","width":90,"editable":true,"editoptions": "<?php //echo '{value:'.$status .'}'?>" ,"edittype":"select","formatter":"select","editrules":{"required":true},"name":"status_id"},
                        ...
                        {"label":"PhotoSuiteDate","index":"photosuite_date","align":"center","width":150,"editable":true,"name":"photosuite_date",'formatter': "date", "editrules":{"date":true},
                       ...
                       // {"label":"PhotoGrapher ","align":"center","index":"username","editable":true,"name":"username"},
                        ...
                        {"label":"Comment","align":"right","index":"comment","name":"comment","editable":true ,'edittype':"textarea", 'editoptions':{'rows':"2",'cols':"30"}}
                    ],
