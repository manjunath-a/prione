...
class CentralDashboardRepository extends EloquentRepositoryAbstract  {
    ...
    public function getDashboardRequestData($userId, $status) {
        ...
        'ticket_transaction.catalogingmanager_id', 'ticket_transaction.catalogingteamlead_id as catalogingteamlead_id',
        'ticket_transaction.cataloguer_id as cataloguer_id',
